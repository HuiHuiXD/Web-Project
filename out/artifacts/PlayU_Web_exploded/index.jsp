    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="contact.html">客服热线</a></li>
            </ul>
            <br style="clear: left" />
        </div> <!-- end of ddsmoothmenu -->
        <div id="templatemo_search">
            <form action="search_result.jsp" method="post">
              <input type="text" name="g_name" id="keyword" title="keyword" onfocus="clearText(this)" onblur="clearText(this)" class="txt_field" />
        ...
        <div id="content" class="float_r">
        	<div id="slider-wrapper">
                <div id="slider" class="nivoSlider">
                    <img src="images/slider/slider1.jpg" alt="" title="Assassin's Creed"/>
                    <img src="images/slider/slider2.jpg"  alt="" title="Roma:Total War" />
                    <img src="images/slider/slider3.jpg" alt="" title="Total War"/>
                    <img src="images/slider/slider4.jpg" alt="" title="Call of Duty" />
                </div>
            </div>
            ...
            <div class="product_box">
	            <h3>汤姆克兰西之全境封锁</h3>
            	<a href="game_infor.jsp?g_id=0001"><img src="images/01.jpg" width="120px" height="160px" alt="Shoes 1" /></a>
                <p>当社会崩坏瓦解，我们将挺身而出!</p>
                <p class="product_price">$ 84</p>
